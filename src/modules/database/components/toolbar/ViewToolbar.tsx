        ...
        >
          <div 
            style={{ 
              ...
              maxHeight: isMobile ? 'calc(100vh - 54px - env(safe-area-inset-bottom) - 40px)' : 'calc(100vh - 100px)',
              zIndex: 99999995, 
              background: '#fff', 
              boxShadow: isMobile ? '0 -8px 32px rgba(0, 0, 0, 0.16)' : '0 16px 36px -8px rgba(15, 23, 42, 0.14), 0 2px 8px rgba(0,0,0,0.04)', 
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow: isMobile ? '0 -8px 32px rgba(0, 0, 0, 0.16)' : '0 12px 32px rgba(15, 23, 42, 0.18), 0 2px 6px rgba(0,0,0,0.06)',
              border: isMobile ? 'none' : '1px solid #e2e8f0',
              borderTop: isMobile ? '1px solid rgba(226, 232, 240, 0.8)' : undefined,
              borderBottom: isMobile ? '1px solid #e2e8f0' : undefined,
